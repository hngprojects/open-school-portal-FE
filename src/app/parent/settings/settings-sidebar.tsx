...
const menuItems = [
  ...
  { id: "profile", label: "Profile", icon: User, href: "/parent/settings/profile" },
  {
    id: "notifications",
    label: "Notifications",
    icon: Bell,
  ...
  },
  {
    ...
    icon: Lock,
    href: "/parent/settings/reset-password",
  },
  {
    id: "legal-privacy",
    label: "Legal & Privacy",
    icon: FileText,
    href: "/parent/settings/legal-and-privacy",
  },
  {
    id: "delete-account",
    label: "Delete Account",
    icon: Trash2,
    href: "/parent/settings/delete-account",
  },
]
              ...
              return (
                <Link
                  ...
                  className={cn(
                    ...
                    isDestructive &&
                      !isActive &&
                      "hover:bg-gray-50 dark:text-red-400 dark:hover:bg-red-950/20"
                  )}
                >
                  <Icon
                    className={cn(
