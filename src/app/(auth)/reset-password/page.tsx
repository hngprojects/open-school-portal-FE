...
const PasswordReset = () => {
  ...
  /* ----------------------------- UI ----------------------------- */
  return (
    <section className="flex min-h-screen w-full overflow-x-hidden bg-white">
      ...
      {/* Right content */}
      <div className="flex w-full flex-col items-center justify-start px-4 pt-[100px] sm:px-8 lg:w-1/2 lg:px-12 xl:px-20">
        {/* Logo */}
        <div className="mb-8 sm:mb-12">
          <Image
            ...
            width={120}
            height={120}
            className="h-[80px] w-[80px] sm:h-[100px] sm:w-[100px] lg:h-[120px] lg:w-[120px]"
          />
        </div>
        ...
        <div className="w-full max-w-[464px]">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-6">
              ...
              {touched.newPassword && errors.newPassword && (
                <p className="mt-2 flex items-start gap-2 text-xs text-[#DA3743]">
                  <span className="flex h-4 w-4 flex-shrink-0 items-center justify-center rounded-full border-2 border-[#DA3743] text-[10px] font-bold text-[#DA3743]">
                    !
                  </span>
                  {errors.newPassword}
                </p>
            ...
            <ul className="mb-6 list-inside list-disc space-y-[10px] text-xs text-[#6B6B6B] sm:mb-8">
