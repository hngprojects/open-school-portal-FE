...
const menuItems = [
  ...
  { id: "profile", label: "Profile", icon: User, href: "/teacher/settings/profile" },
  {
    id: "notifications",
    label: "Notifications",
    icon: Bell,
  ...
  },
  {
    ...
    icon: Lock,
    href: "/teacher/settings/reset-password",
  },
  {
    id: "legal-privacy",
    label: "Legal & Privacy",
    icon: FileText,
    href: "/teacher/settings/legal-and-privacy",
  },
  {
    id: "delete-account",
    label: "Delete Account",
    icon: Trash2,
    href: "/teacher/settings/delete-account",
  },
]
