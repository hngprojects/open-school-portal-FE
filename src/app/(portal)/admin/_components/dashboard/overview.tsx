...
//   const activities = todayActivitiesData?.todays_activities ?? []
...
//   //     (act) =>
//   //       act?.teacher?.full_name.toLowerCase().includes(term) ||
//   //       act.subject.name.toLowerCase().includes(term) ||
//   //       act.class.name.toLowerCase().includes(term)
//   //   )
//   // }, [activities, searchTerm])
//   // const filteredActivities = useMemo(() => {
//   //   if (!searchTerm) return activities
