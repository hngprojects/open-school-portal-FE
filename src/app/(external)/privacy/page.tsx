...
// const PrivacyPolicy = () => {
//   return (
//     <article className="prose mx-auto mb-20 max-w-5xl px-3 pt-6 md:pt-16 lg:px-5">
...
//         </p>
//         <p>
//           This policy applies only to the School Base global website, where visitors learn
//           about the product, download installers, or access documentation.
//         </p>
//         <p className="font-semibold">
//           It does not apply to self-hosted school instances using School Base, as each
//           school is responsible for its own data policies.
...
//         <h2 className="text-primary mb-2 text-xl font-bold">1. Information We Collect</h2>
...
//         </ul>
//         <p className="text-text-secondary mt-3 font-medium">
//           The OSP landing page does not store sensitive personal data, login credentials,
//           or school data.
//         </p>
//       </section>
...
//           </li>
//           <li>
//             Schools must implement their own privacy policies, terms, and data governance.
//           </li>
//         </ul>
//       </section>
